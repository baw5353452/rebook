...
<div class="container">
  <form action="login_do.php" method="post" class="registerform pull-left">
      <table>
          ...
          <tr>
              <td>昵称：</td>
              <td><input type="text" errormsg="请输入您的昵称" datatype="*" class="inputxt Validform_error" name="email" nullmsg="请填写信息"></td>
              <td><div class="Validform_checktip Validform_wrong"></div></td>
          </tr>
          <tr>
              <td >密码：</td>
              <td><input type="password" name="password" class="inputxt" datatype="*6-16" nullmsg="请设置密码" errormsg="密码范围在6~16位之间" /></td>
